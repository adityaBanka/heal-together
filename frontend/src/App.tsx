    ...
    <div className="bg-rose-50/50 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
      ...
      <div className="w-fit pt-10 md:pt-30 mx-[10%] md:mx-[20%] flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-start">
          <p className="text-4xl font-zilla-slab-bold my-5">Let's <span className="text-rose-400 text-5xl">{safeMode ? "true" : "false"}</span> our minds together.</p>
        ...
        <div className="flex md:flex-row items-center justify-center w-full space-x-10">
          <div
        ...
        <div className="w-full flex flex-col items-start mt-25">
          ...
          <Accordion type="multiple" className="w-full mt-5">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                <p className="text-xl font-zilla-slab-light-italic">None of the data used to train our model is stored on our servers. All data is processed locally on our servers and never leaves our servers. We have implemented strict data security measures to ensure the privacy and confidentiality of our users' data.</p>
              </AccordionContent>
            </AccordionItem>
